...
// Uso de tecnologias no Adapter para isolar o "Core"
@Configuration
@ComponentScan(basePackageClasses = NotificationHexApplication.class)
public class BeanConfiguration {

    // Colocando o NotificationServicePortImpl como um Bean do Spring que recebe um construtor do tipo NotificationPersistencePort.
    @Bean
